      ...
      <div class="page-content header-clear-small">
              ...
              <div class="splide__slide">
                <div class="card rounded-m shadow-l mx-3">
                  <div class="card-bottom text-center mb-0">
                    ...
                    <p class="color-white opacity-80 mb-4">
                ...
                <div class="card card-style">
                  <div class="content mb-0">
                    ...
                    <p class="boxed-text-xl mt-n3">
                      Call to action are highly important, but we can't choose a
                      style for you, so we created a few!
                    </p>
                    <a
                      href="#"
                      class="btn btn-m btn-center-l bg-red-dark text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4"
                      >Swipe Left to Begin</a
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="card card-style">
                  <div class="content">
                    ...
                    <p class="text-center pb-2">
                      <a
                        href="#"
                        class="icon icon-s rounded-s shadow-xl color-white bg-facebook"
                        ><i class="fab fa-facebook-f"></i
                      ></a>
                      <a
                        href="#"
                        class="icon icon-s rounded-s shadow-xl color-white bg-phone ms-2 me-2"
                        ><i class="fa fa-phone"></i
                      ></a>
                      <a
                        href="#"
                        class="icon icon-s rounded-s shadow-xl color-white bg-twitter"
              ...
              <div class="splide__slide">
                <div class="card card-style">
                  <div class="content mb-0">
                    ...
                    <p class="boxed-text-xl mt-n3">
                      Multiple choices are awesome, highlighting them is even
                      easier with our Call to Actions
                    </p>
                    <p class="text-center mt-n3 mb-0 pb-0">
                      <a
                        href="#"
                        class="btn btn-m bg-green-dark text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4 mt-3"
                        >Call Now</a
                      >
                      <a
                        href="#"
                        class="icon icon-m rounded-s opacity-40 color-theme ms-3 me-3"
                        >or</a
                      >
                      <a
                        href="#"
                        class="btn btn-m bg-red-dark text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4 mt-3"
                        >GET A QUOTE</a
                      >
                    </p>
                  </div>
              ...
              <div class="splide__slide">
                <div class="card card-style">
                  <div class="content mb-0">
                    ...
                    <p class="text-center color-highlight mt-n1 mb-2 font-12">
                      Invite Users to Tap Button
                    </p>
                    <p class="boxed-text-xl">
                      Make a button stand out at the top of your page so it's
                      easily accessible as a first option.
                    </p>
                    <a
                      href="#"
                      class="btn btn-m btn-center-l bg-red-dark text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4"
                      >Purchase today for $25</a
                    >
                  </div>
                </div>
              </div>
        ...
        <div class="card card-style">
          <div class="content mb-0">
            ...
            <p class="text-center color-highlight font-11 mt-n1">
              The Absolute Best Products & Care for You
            </p>
            <p class="boxed-text-xl mt-n3">
              Over 10 years of Experience in Building Gorgeous Products only for
              you! We are Envato Elite.
            </p>
        ...
        <div
          class="splide double-slider slider-no-arrows slider-no-dots"
              ...
              <div class="splide__slide">
                ...
                >
                  <div class="card-bottom text-center">
                    ...
                    <a
                      href="#"
                      class="btn btn-s btn-full text-uppercase font-900 bg-red-dark rounded-s me-2 ms-2 mb-2"
                      >Purchase</a
                    >
                  </div>
                  <div class="card-overlay bg-gradient"></div>
        ...
        <div class="card card-style">
          <div class="content mb-4">
            ...
            <a
              href="#"
              class="btn btn-m btn-center-l text-uppercase font-900 bg-red-dark rounded-sm shadow-xl mt-4 mb-0"
              >More Testimonials</a
            >
          </div>
        </div>
            ...
            <div class="splide__list">
              <div class="splide__slide">
                <div
                  ...
                  class="card mx-3 rounded-m shadow-l bg-18"
                >
                  ...
                  <div class="card-bottom ms-3">
                    ...
                    <p class="color-white font-11 mt-n1 mb-2">
              ...
              <div class="splide__slide">
                <div
                  data-card-height="180"
                  class="card mx-3 rounded-m shadow-l bg-14"
                >
                  <div class="card-top ms-3 mt-3">
              ...
              <div class="splide__slide">
                <div
                  data-card-height="180"
                  class="card mx-3 rounded-m shadow-l bg-3"
                >
                  <div class="card-top ms-3 mt-3">
        ...
        <div class="card card-style">
          <div class="content mb-0">
            ...
            <p class="boxed-text-xl mt-n3">
              Fast, easy to use and filled with features. Get Sticky Today and
              give your site the Mobile Feeling it deserves.
            </p>
            <a
              href="#"
              class="btn btn-m btn-center-l text-uppercase font-900 bg-red-dark rounded-sm shadow-xl mb-4"
              >Purchase Now - $25</a
            >
          </div>
        </div>
